...
{/* initJSXid_categoria */}
                ...
                <div className="2xl:col-span-5 lg:col-span-4 sm:col-span-2 col-span-1 col-span-1 border-b-4 border-gray-200">
                    <MultiCheckbox label="Seleccionar Categorias" options={categoria_list} field="nombre_categoria" values={casos?.id_categoria} setValues={e => set_casos({ ...casos, id_categoria: e })} />
                </div>
