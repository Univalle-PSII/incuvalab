...
export default function Autor_report({ modal, camposInit = [] }) {
    ...
    function downloadPDF() {
        ...
        doc.html(divContents, {
            callback: function (doc) {
                ...
                const nombreArchivo = `ReporteAutor_${fechaActual.toLocaleDateString().replace(/\//g, '-')}_${fechaActual.toLocaleTimeString().replace(/:/g, '-')}.pdf`;
...
//camposExcel
        ...
        const fechaActual = new Date();
        const nombreArchivo = `ReporteAutor_${fechaActual.toLocaleDateString().replace(/\//g, '-')}_${fechaActual.toLocaleTimeString().replace(/:/g, '-')}`;
        ...
        <>
            <IonHeader>
                <IonToolbar>
                    ...
                    <IonTitle>Reporte de Autor</IonTitle>
                </IonToolbar>
            </IonHeader>
...
{/* endJSXprofesion */}
{/* camposTabla */}
                                        {camposSeleccionados.includes("last_user") && <td>{autor?.last_user?.name}</td>}
