...
import Categoria_report from "./Categoria_report";

const docForPage = 50;

export default function Categoria_list() {
    ...
    useEffect(() => {
        ...
        temp.create = store.checkPermissions(["create_categoria"]);
    ...
    return (
        <Page title="Lista de Categoria" createURL={permissions.create ? "/app/categoria/create" : null} permissions="read_categoria">
            ...
            <IonList className="w-full">
                {list.map((categoria, index) => (
                    <React.Fragment key={index}>
                        <IonItem routerLink={`/app/categoria/detail/${categoria._id}`} routerDirection="forward">
...
{/* fields */}
            ...
            <IonModal ref={modal} trigger="open-report">
                <Categoria_report modal={modal} camposInit={[
                    //camposDefault
                ]} />
            </IonModal>
        </Page>
