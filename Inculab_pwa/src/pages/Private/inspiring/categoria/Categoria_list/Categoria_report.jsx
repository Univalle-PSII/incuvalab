...
export default function Categoria_report({ modal, camposInit = [] }) {
    ...
    function downloadPDF() {
        ...
        doc.html(divContents, {
            callback: function (doc) {
                ...
                const nombreArchivo = `ReporteCategoria_${fechaActual.toLocaleDateString().replace(/\//g, '-')}_${fechaActual.toLocaleTimeString().replace(/:/g, '-')}.pdf`;
...
//camposExcel
        ...
        const fechaActual = new Date();
        const nombreArchivo = `ReporteCategoria_${fechaActual.toLocaleDateString().replace(/\//g, '-')}_${fechaActual.toLocaleTimeString().replace(/:/g, '-')}`;
        ...
        <>
            <IonHeader>
                <IonToolbar>
                    ...
                    <IonTitle>Reporte de Categoria</IonTitle>
                </IonToolbar>
            </IonHeader>
...
{/* endJSXdescripcion */}
{/* camposTabla */}
                                        {camposSeleccionados.includes("last_user") && <td>{categoria?.last_user?.name}</td>}
